...
# Initialize Celery
celery_app = Celery('whatsapp_processor')
...
def process_whatsapp_message_task(self, message_id: str, customer_id: str, practice_id: str):
    ...
    try:
        ...
        return asyncio.run(_process_whatsapp_message_async(
...
async def _process_whatsapp_message_async(message_id: str, customer_id: str, practice_id: str):
    """
    Async function to process WhatsApp messages with LangGraph agents.
    """
